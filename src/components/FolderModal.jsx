...
import { X, FolderOpen, User, Share2, Lock, Save, AlertCircle } from 'lucide-react'

const FolderModal = ({ isOpen, onClose, folder, onSave }) => {
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    {folder ? 'Update folder information' : 'Create a new folder'}
                  </p>
                </div>
              </div>
              <motion.button
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div className="text-left">
                    <div className="font-medium text-gray-900 dark:text-white">
                      {formData.isShared ? 'Shared Folder' : 'Private Folder'}
                    </div>
                    <div className="text-sm text-gray-600 dark:text-gray-400">
                      {formData.isShared 
                        ? 'Other users can access this folder' 
                        : 'Only the owner can access this folder'
                      }
                    </div>
                  </div>
                </div>
